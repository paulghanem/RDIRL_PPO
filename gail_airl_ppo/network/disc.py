...
class RGCLCost(nn.Module):
    ...
    # --- Helper Methods for RGCL Update ---

    def get_theta(self):
        """Returns current parameters as a flat vector theta."""
        return utils.parameters_to_vector(self.parameters()).detach()

    def set_theta(self, theta_vec):
        """Loads a flat vector theta back into the network weights."""
        utils.vector_to_parameters(theta_vec, self.parameters())